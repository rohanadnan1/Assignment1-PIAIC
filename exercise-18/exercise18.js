...
while (guest_list.length > 2) {
    var guest_removed = guest_list.pop();
    console.log("Sorry ".concat(guest_removed, " we cannot invite you to dinner"));
}
for (var index = 0; index < guest_list.length; index++) {
    var invite_msg = "Hey ".concat(guest_list[index], " I would like to invite to a dinner...");
    console.log(invite_msg);
}
console.log("We are inviting these two perople for dinner!");
